...
<head>
    ...
    <title>Transilvanian Brew - Despre noi</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta name = "description" content = "Cafeneaua noastră a fost fondată în 1995 și este deținută de o familie care își dorește să ofere o experiență autentică într-o atmosferă plăcută. Utilizăm numai ingrediente proaspete și de înaltă calitate pentru a vă oferi cele mai bune băuturi și gustări din oraș.">
    ...
    <div class="container-fluid py-5">
        <div class="container">
            <div class="section-title">
                ...
                <h3 class="display-4">Servim cu pasiune din anul 1950</h3>
            </div>
            <div class="row">
